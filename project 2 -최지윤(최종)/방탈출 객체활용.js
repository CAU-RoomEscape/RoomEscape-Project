...
// 방생성
room1=new Room('room1','room1.png')
...
//오른쪽 이동, 이동
room1.dirR=new Direction(room1,'dirR','마우스.png',room2)
room1.dirR.resize(100)
room1.dirR.locate(1200,430)

room2.dirR=new Direction(room2,'dirR','마우스.png',room3)
room2.dirR.resize(100)
room2.dirR.locate(1200,430)

room3.dirR=new Direction(room3,'dirR','마우스.png',room4)
room3.dirR.resize(100)
room3.dirR.locate(1200,430)

room4.dirR=new Direction(room4,'dirR','마우스.png',room1)
room4.dirR.resize(100)
room4.dirR.locate(1200,430)

//왼쪽 방향, 이동

room1.dirL=new Direction(room1,'dirL','마우스.png',room4)
room1.dirL.resize(100)
room1.dirL.locate(100,430)

room4.dirL=new Direction(room4,'dirL','마우스.png',room3)
room4.dirL.resize(100)
room4.dirL.locate(100,430)

room3.dirL=new Direction(room3,'dirL','마우스.png',room2)
room3.dirL.resize(100)
room3.dirL.locate(100,430)

room2.dirL=new Direction(room2,'dirL','마우스.png',room1)
room2.dirL.resize(100)
room2.dirL.locate(100,430)
...
//윗 방향 설정, 이동
room1.dirU=new Direction(room1,'dirU','마우스.png',room1U)
room1.dirU.resize(100)
room1.dirU.locate(650,80)
...
//아래 방향 설정, 이동
room1U.dirD=new Direction(room1U,'dirD','마우스.png',room1)
...
//box1 생성
room1.box1=new Object(room1,'box1','마우스.png')
room1.box1.resize(50)
room1.box1.locate(320,380)
...
//잠겨있는 문 
room1.text=new Object(room1,'text','마우스.png')
room1.text.resize(200)
room1.text.locate(650,350)
room1.text.onClick=function(){
	printMessage("문은 자물쇠로 잠겨있다.")
}

// 전등
room1.text1=new Object(room1,'text1','마우스.png')
room1.text1.resize(100)
room1.text1.locate(1050,125)
room1.text1.onClick=function(){
	printMessage("불이 켜진 것도 있고.. 꺼진 것도 있고.. ")
}

// 얼룩
room1.text2=new Object(room1,'text2','마우스.png')
room1.text2.resize(100)
room1.text2.locate(1050,600)
room1.text2.onClick=function(){
	printMessage("검붉은 얼룩이 묻어있다..")
}


//box2 생성
room1.box2=new Object(room1,'box2','마우스.png')
room1.box2.resize(100)
room1.box2.locate(1000,380)
room1.box2.close()
...
//손잡이 생성 
room1.handle=new Item(room1,'handle','손잡이.png')
room1.handle.resize(800)
room1.handle.locate(540,350)
room1.handle.hide()
...
//쌍안경 생성
room2.scope=new Item(room2,'scope','쌍안경.png')
room2.scope.resize(100)
room2.scope.locate(600,400)

//그림 보기
room2.picture=new Object(room2,'picture','마우스.png')
room2.picture.resize(100)
room2.picture.locate(615,260)
room2.picture.onClick =function(){
    showImageViewer("그림.png");
}

//드라이버 앞부분 생성
room2.head=new Item(room2,'head','앞부분.png')
room2.head.resize(60)
room2.head.locate(1050,650)
