...
room2.phone.onClick = function(){
	if(room2.closet.isLocked()){
		showKeypad('telephone', '001', function(){
			room2.closet.unlock()
...
room3.lock1 = new Object(room3, 'lock1', '키패드-우.png')
...
storage.direction = new Direction(storage, 'direction', '화살표-아래.png', room3)
